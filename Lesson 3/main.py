...
# Destination & joke data // objects / dictionary
destinations = {
...
def chat():
        print(Fore.CYAN + "Hello Travell Bot Here,")
        ...
        while True:
            ...
            if "recommend" in user_input or "suggest" in user_input:
                ...
                print(Fore.RED + "Bye Have a Good Day")
            else:
                print(Fore.CYAN + "Travelbot : Could You rephrase")            
